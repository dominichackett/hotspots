...
export default function Donations() {
  const [portals ,setPortals] = useState([{portalId:1,name:"Sporty Arcade"}])
  const getSubscriptions = async (event:any)=>{
       ...
       <Header option={"Subscriptions"}/>
        <header className="bg-white shadow-sm">
          <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
            <h1 className="text-lg font-semibold leading-6 text-gray-900">Subscriptions</h1>
            <div className="w-full mt-2">
              <div className="flex items-center ">
              <select onChange={getSubscriptions} 
              id="portals"
